# Generated by Django 2.2.6 on 2019-12-08 01:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Unique name for you rideshare community', max_length=20, unique=True)),
                ('areas', models.ManyToManyField(help_text='The areas in which this community will offer rideshares in (this is used for Riders to find the right communities)', to='rideshare.Place')),
                ('members', models.ManyToManyField(help_text='The Riders that are allowed to create and participate in ridesharing in this community', related_name='member_of_rideshare_community', to='rideshare.Rider')),
                ...
                ('rideshares', models.ManyToManyField(help_text='The current rideshares that are listed under this community', to='rideshare.RideShare')),
            ],
        ),
    ]
